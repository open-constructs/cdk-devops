...
### Hello <a name="Hello" id="cdk-devops.Hello"></a>

#### Initializers <a name="Initializers" id="cdk-devops.Hello.Initializer"></a>

```typescript
import { Hello } from 'cdk-devops'
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#cdk-devops.Hello.sayHello">sayHello</a></code> | *No description.* |

---

##### `sayHello` <a name="sayHello" id="cdk-devops.Hello.sayHello"></a>
